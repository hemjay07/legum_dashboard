...
export default function UsersOrLawyersLocations({ person }) {
  return (
    <div class=" h-full py-6">
      ...
      <div class="relative mt-6  w-full rounded-lg border bg-white p-4 shadow-md ">
        <div class="grid  grid-cols-5 justify-between bg-gray-100  px-2 py-2 ">
          <span class="col-span-3 lg:col-span-2">
            <span class="mr-4">#</span>
            <span>Location</span>
          </span>
          <span class="hidden lg:block">Number of users</span>
          <span class="hidden lg:block">Percentage (%)</span>
